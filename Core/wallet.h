...
public:
    ...
    // Micro-Wallet fields
    virtual QByteArray      walletId() const            { return WalletDataCoreValueToByteArray(walletDataCore(),QStringLiteral("walletId")); }     // Generated by our server
    ...
    virtual void            setWalletId(const QByteArray iValue)    { WalletDataCoreValueFromByteArray(walletDataCore(),QStringLiteral("walletId"),iValue); }
