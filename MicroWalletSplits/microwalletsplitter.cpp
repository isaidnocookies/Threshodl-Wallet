...
int MicroWalletSplitter::getMicroWalletValues(double iInitialAmount, std::vector<double> &oBreaks, int iPasses)
{
...
int MicroWalletSplitter::getMicroWalletValues(double iInitialAmount, std::vector<BValue> &oBreaks, int iPasses)
{
...
bool MicroWalletSplitter::checkCompleteness(std::vector<double> iBreaks, double iTotal)
{
...
int MicroWalletSplitter::estimateBreakdown(double iValue)
{
...
int MicroWalletSplitter::getPlaceMultiplier(int indexOfDecimal, int currentIndex)
{
...
double MicroWalletSplitter::getValueFromBValue(BValue iValue)
{
    return iValue.value * (std::pow(10.0, iValue.multiplier));
}

BValue MicroWalletSplitter::getBreakValue(BValue iValue)
{
    BValue lBreakValue;
...
BValue MicroWalletSplitter::getBreakValueRemainder(BValue iValue)
{
...
std::vector<BValue> * MicroWalletSplitter::getBreaks(double iStartValue, int iPasses)
{
...
bool MicroWalletSplitter::greaterThanBValue(BValue iLHS, BValue iRHS)
{
