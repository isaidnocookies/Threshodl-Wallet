...
#include "../Server/QtWebApp/httpserver/httpconnectionhandlerpool.h"
...
struct qt_meta_stringdata_HttpConnectionHandlerPool_t {
    QByteArrayData data[3];
    char stringdata0[35];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_HttpConnectionHandlerPool_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HttpConnectionHandlerPool_t qt_meta_stringdata_HttpConnectionHandlerPool = {
    {
QT_MOC_LITERAL(0, 0, 25), // "HttpConnectionHandlerPool"
QT_MOC_LITERAL(1, 26, 7), // "cleanup"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "HttpConnectionHandlerPool\0cleanup\0"
};
...
const QMetaObject HttpConnectionHandlerPool::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HttpConnectionHandlerPool.data,
      qt_meta_data_HttpConnectionHandlerPool,  qt_static_metacall, nullptr, nullptr}
};
...
void *HttpConnectionHandlerPool::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HttpConnectionHandlerPool.stringdata0))
