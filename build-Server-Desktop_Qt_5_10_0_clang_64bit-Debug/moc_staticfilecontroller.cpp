...
#include "../Server/QtWebApp/httpserver/staticfilecontroller.h"
...
struct qt_meta_stringdata_StaticFileController_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_StaticFileController_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_StaticFileController_t qt_meta_stringdata_StaticFileController = {
    {
QT_MOC_LITERAL(0, 0, 20) // "StaticFileController"
...
const QMetaObject StaticFileController::staticMetaObject = {
    { &HttpRequestHandler::staticMetaObject, qt_meta_stringdata_StaticFileController.data,
      qt_meta_data_StaticFileController,  qt_static_metacall, nullptr, nullptr}
};
...
void *StaticFileController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StaticFileController.stringdata0))
