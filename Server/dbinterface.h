...
public:
    ...
    virtual bool microWalletExists(const QStringList iMicroWalletId)                                                                    = 0;

    virtual bool microWalletOwnershipCheck( const QString iMicroWalletId, const QString iAddress )                                      = 0;
    virtual bool microWalletOwnershipCheck( const QStringList iMicroWalletIds, const QString iAddress )                                 = 0;
    ...
    virtual bool microWalletChangeOwnership( const QStringList iMicroWalletIds, const QString iFromAddress, const QString iToAddress )  = 0;
